...
###                                             or, JUST THE NET                                                    ###
###                                                                                                                 ###
###  Bottom Dollar (Just the Net) is a financial phone app that displays the amount your savings                    ###
...
def main():
    ...
    def ticker():
        """This while loop in this function runs continuously. It displays the current position as it increases."""
        global position
        ...
        """Tuple assignment containing the variables to be used in the subsequent while loop.
            ...
            """
        if report_pref == 'd':
            prefs = ('day', net_day, 86400) #86400, 1 for testing.
        elif report_pref =='h':
            prefs = ('hour', net_hour, 3600) #3600, 1 for testing.
        elif report_pref == 'm':
            prefs = ('minute', net_min, 60) #60, 1 for testing.
        elif report_pref == 's':
...
# * Should a function return an integer as int, float, or str. Styleguide?
