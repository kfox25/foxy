...
## I was unsuccessful combining this with check_integer()
def check_2400(prompt):    
    while True:
        value = int(input(prompt))
        if value >= 0 and value < 2400:
            break
        else:
            print('Entry must be between 0 and 2400! Try again.')
    return value
...
if work_pref == 'Y':
    day_start = check_integer('What time does your workday start? 830 = 8:30AM: ')
    day_end = check_integer('What time does your workday end? 1730 = 5:30PM: ')
